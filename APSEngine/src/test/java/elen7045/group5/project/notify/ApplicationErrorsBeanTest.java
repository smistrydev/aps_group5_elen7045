...
public class ApplicationErrorsBeanTest {
	ApplicationErrorsBean app1 = new ApplicationErrorsBean(EApplicationErrors.ACTION_REQUIRED_BY_BILLING_WEBSITE);
	ApplicationErrorsBean app2 = new ApplicationErrorsBean(EDataErrors.DATA_FAILS_INTEGRITY_CHECKING);
	ApplicationErrorsBean app3 = new ApplicationErrorsBean(EScrapperSchedularErrors.SCHEDUKER_REACHED_MAXIMUM_RETRIES);
	ApplicationErrorsBean app4 = new ApplicationErrorsBean(EUserInterfaceErrors.INVALID_USER_NAME);
	@Test
