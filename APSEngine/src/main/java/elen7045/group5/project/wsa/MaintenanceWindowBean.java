...
/**
 * Bean represents the maintenance periods that each billing company may have. This
 * schedule needs to be enforced by the APS engine when it scans for possible scraping 
 */
