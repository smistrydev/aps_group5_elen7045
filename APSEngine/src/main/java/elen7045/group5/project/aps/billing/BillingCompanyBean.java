...
public class BillingCompanyBean implements Serializable
{
	...
	/**
	 * This is the number of days between when a statement is generated/made
	...
	/**
	 * This is the number of minutes that the scraper should wait before the
	 * next retry
	 * 
	...
	/**
	 * The number of days the scraper should try and check for an available
	 * statement
	 * 
