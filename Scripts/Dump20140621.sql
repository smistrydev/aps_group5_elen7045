...
CREATE TABLE `credit_card_provider` (
  `credit_card_provider_id` int(11) NOT NULL,
...
CREATE TABLE `scrape_data` (
  `scrape_data_id` int(11) NOT NULL,
...
CREATE TABLE `statement_provider` (
  `statement_provider_id` int(11) NOT NULL,
...
CREATE TABLE `telco_service_provider` (
  `telco_service_provider_id` int(11) NOT NULL,
  `statement_id` int(11) DEFAULT NULL,
...
-- Dump completed on 2014-06-21 20:37:43
