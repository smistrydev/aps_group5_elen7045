...
/**
 * Engine is implemented as a Timer as it will execute at regular intervals
 * and check if scheduling is required to be performed.
 * 
...
public class AccountPresentationEngine extends Timer
{
	 ...
	 * @param bcb - Billing company info
	 */
	...
	/**
	 * Method kicks off the whole process of retrieving, validating and persisting
	 * scraped data
	 */
	public void process()
	{
		...
		//go through each one and perform a scrape - perhaps this should also be threaded?		
